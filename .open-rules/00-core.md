...
- **Git workflow**: You must commit all the changes you build in a logical way. Create clear, descriptive, atomic commits for every unit of work you accomplish or feature you build.